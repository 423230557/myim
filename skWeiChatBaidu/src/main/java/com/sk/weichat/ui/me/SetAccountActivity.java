...
public class SetAccountActivity extends BaseActivity {
    ...
    private void initActionBar() {
        ...
        tvTitle.setText(getString(R.string.sk_account_set, getString(R.string.app_name)));
    }

    private void initView() {
        TextView singleDesc = findViewById(R.id.sk_account_single_tv);
        singleDesc.setText(getString(R.string.sk_account_single, getString(R.string.app_name)));
