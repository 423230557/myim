...
-keep class com.sk.weichat.bean.circle** { *; }
-keep class com.sk.weichat.bean.collection** { *; }
-keep class com.sk.weichat.bean.company** { *; }
-keep class com.sk.weichat.bean.message** { *; }
-keep class com.sk.weichat.bean.redpacket** { *; }
-keep class com.sk.weichat.bean.**
-keep class com.sk.weichat.circle.**
-keep class com.sk.weichat.collection.**
-keep class com.sk.weichat.company.**
-keep class com.sk.weichat.message.**
-keep class com.sk.weichat.redpacket.**
